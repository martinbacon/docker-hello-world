...
ghcr.io/martinbacon/docker-hello-world     latest    2b28c6ad8d1b    4 months ago     1.2MB
```
...
```bash
$ docker run -d --rm --name web-test -p 80:8000 ghcr.io/martinbacon/docker-hello-world:1.0.1
```
